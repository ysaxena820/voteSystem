<header class="main-header" style="background-color:#4682B4 " >
  <!-- Logo -->
  <a href="#" class="logo " style="background-color: #4682B4">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini" style="background-color: #4682B4 "><b>O</b>VS</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg " style="background-color:#4682B4 ;color:white ; font-size: 22px; font-family:Times  "><marquee behavior="scroll" direction="left">Online Voting System</marquee></span>
    

  </a>
  <!-- Header Navbar: style can be found in header.less -->
  <nav class="navbar navbar-static-top " style="background-color: #4682B4 ">
    ...
    <div class="navbar-custom-menu" style="color:black ; font-size: 17px; font-family:Times">
      <ul class="nav navbar-nav" style="background-color: #4682B4 ;color:black ; font-size: 17px; font-family:Times" >
        <!-- User Account: style can be found in dropdown.less -->
        <li class="dropdown user user-menu  " style="color:black">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #4682B4 ;color:white ; font-size: 17px; font-family:Times" >
            <img src="<?php echo (!empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/profile.jpg'; ?>" class="user-image" alt="User Image">
            <span class="hidden-xs">CU Admin</span>
          </a>
          <ul class="dropdown-menu" style="background-color: #4d5863 ;color:black ; font-size: 17px; font-family:Times">
            ...
            <li class="user-header" style="background-color:#4d5863 ;color:black ; font-size: 17px; font-family:Times">
              <img src="<?php echo (!empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/WhatsApp Image 2021-05-27 at 17.55.34.jpg'; ?>" class="img-circle" alt="User Image">
